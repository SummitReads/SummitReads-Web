...
/**
 * Landing page UI. Sprint count is fetched on the server (page.js) and passed
 * in so first paint already has the correct "N sprints live" — no client flash.
 */
export default function LandingClient({ sprintCount = 14 }) {
  ...
  const count =
    typeof sprintCount === 'number' && sprintCount > 0 ? sprintCount : 14
  const sprintCountLabel = count.toLocaleString('en-US')
