...
const ONBOARDING_KEY = 'summitreads_onboarded';
...
function LogoIcon() {
  return (
    <div style={{
      ...
      <img src="/SummitReads-Logo.png" alt="SummitReads"
...
const STEPS = [
  { tag: 'Welcome',            title: 'Skills that actually stick.',   body: 'SummitReads is built on one insight: reading about a skill and building it are completely different things. Every sprint requires you to do the work — not just consume it.', icon: 'logo',    hasPreview: false },
